...
Finally, we will create a linear regression to determine how the independent variables (race, insurance type, cancer stage, income level, and education level) influence the dependent variable (mortality rate). 
